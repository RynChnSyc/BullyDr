...
void logD(JNIEnv *env, const char * msg, ...)
{
    if (env->ExceptionCheck() == JNI_FALSE) {
        jclass cls = env->FindClass("com/example/drbully/BullyDec");
...
Java_com_example_drbully_BullyDec_analyzeWav(JNIEnv *env, jobject instance,
                                                       jstring fileName_){
    ...
    if(env->ExceptionCheck())
    {
        ...
        jclass cls = env->FindClass("com/example/drbully/EmotionProbabilities");
